$(document).ready(function () {
  ...
  function first(){
    ...
    let PositionY_1 = 0;
    let temp_1 = 0;
    let LastPosition_BlueBox_1 = [blueIndex_1 * 50, PositionY_1];
    function loop_1() {


        blueBox_1.animate([
            { transform: `translate(${LastPosition_BlueBox_1[0]}px,${LastPosition_BlueBox_1[1]}px)` },
      ...
      LastPosition_BlueBox_1 = [blueIndex_1 * 50, PositionY_1];
